...
public class GradeReportDaoImpl implements GradeReportDao {
    ...
    @Override
    public void add(GradeReport gradeReport) throws RepositoryException {
        if (gradeReport != null) {
     ...
     */
    @Override
    public void remove(GradeReport gradeReport) throws RepositoryException {
        if (gradeReport != null) {
            try (ProxyConnection connection = ConnectionPool.INSTANCE.getConnection();
     ...
     */
    @Override
    public void update(GradeReport gradeReport) throws RepositoryException {
        if (gradeReport != null) {
            try (ProxyConnection connection = ConnectionPool.INSTANCE.getConnection();
     ...
     */
    @Override
    public Set<GradeReport> query(Specification<GradeReport> specification) throws RepositoryException {
